...
public class Menu extends JPanel {
	...
	private final String headerName = "My Cinema";
	...
	private final String menuItems[][] = { { "~Management~" }, { "Movie Management" }, { "Screening Management" },
			{ "Staff Management" }, { "Customer Management" }, { "Product Management", "Foods", "Drinks" },
			{ "~Other~" }, { "Statistics", "General", "Customer", "Movie", "Product" },
			{ "Profile", "Infomation", "Change Password" }, { "Logout" } };
