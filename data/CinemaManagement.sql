...
BEGIN
    ...
    SET @OrderID = @InsertedOrderID;
END;
go

CREATE OR ALTER FUNCTION fn_ProductSalesByYearMonthDay (@Year INT,@Month INT = NULL,@Day INT = NULL)
RETURNS @ProductSales TABLE (ProductName NVARCHAR(MAX),TotalQuantity INT,TotalPrice MONEY)
AS
BEGIN
    INSERT INTO @ProductSales (ProductName, TotalQuantity, TotalPrice)
    SELECT p.ProductName, SUM(od.Quantity) AS TotalQuantity, SUM(od.Quantity * p.Price) AS TotalPrice
...
(
    SELECT
        (SELECT ISNULL(SUM(Total), 0) FROM OrderAddProduct WHERE YEAR(AddProductDate) = @year AND (@month IS NULL OR MONTH(AddProductDate) = @month)) AS TotalAddProduct,
        (SELECT ISNULL(SUM(Total), 0) FROM OrderImportProduct WHERE YEAR(ImportProductDate) = @year AND (@month IS NULL OR MONTH(ImportProductDate) = @month)) AS TotalImportProduct,
        (SELECT ISNULL(SUM(Total), 0) FROM [dbo].[OrderAddMovie] WHERE YEAR(AddMovieDate) = @year AND (@month IS NULL OR MONTH(AddMovieDate) = @month)) AS TotalAddMovie
);
go

CREATE OR ALTER FUNCTION CalculateTotalOrderAmountByYearMonth(@year INT,@month INT)
RETURNS TABLE
AS
RETURN
(
    SELECT 
        ISNULL(SUM(od.LineTotal), 0) AS TotalProduct,
        ISNULL(SUM(o.QuantitySeat * ms.PricePerSeat), 0) AS TotalSeat
    FROM [Order] o
...
CREATE OR ALTER FUNCTION GetSeatSoldByHour (@Year INT ,@Month INT ,@Day INT)
RETURNS TABLE
AS
RETURN
(
    WITH Hours AS (SELECT 0 AS Hour UNION ALL SELECT Hour + 1 FROM Hours WHERE Hour < 23)
    SELECT h.Hour, ISNULL(SUM(o.QuantitySeat), 0) AS SeatSold
    FROM Hours h LEFT JOIN [Order] o 
	ON DATEPART(hour, o.OrderDate) = h.Hour 
		AND YEAR(o.OrderDate) = @Year AND MONTH(o.OrderDate) = @Month AND DAY(o.OrderDate) = @Day
    GROUP BY h.Hour
...
VALUES ('The Shawshank Redemption', 'Drama', 'Frank Darabont', 142, '1994-09-23', 'English', 'USA', '1994-09-23', 'Released', 1100.99, 'images/shawshank_redemption.jpg', 'https://www.youtube.com/watch?v=6hB3S9bIaco', 'Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('The Godfather', 'Crime', 'Francis Ford Coppola', 175, '1972-03-24', 'English', 'USA', '1972-03-24', 'Unreleased', 1120.99, 'images/the_godfather.jpg', 'https://www.youtube.com/watch?v=5DO-nDW43Ik', 'The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('The Dark Knight', 'Action', 'Christopher Nolan', 152, '2008-07-18', 'English', 'USA', '2008-07-18', 'Released', 1140.99, 'images/the_dark_knight.jpg', 'https://www.youtube.com/watch?v=EXeTwQWrcwY', 'When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman must accept one of the greatest psychological and physical tests of his ability to fight injustice.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Pulp Fiction', 'Crime', 'Quentin Tarantino', 154, '1994-10-14', 'English', 'USA', '1994-10-14', 'Unreleased', 1110.99, 'images/pulp_fiction.jpg', 'https://www.youtube.com/watch?v=s7EdQ4FqbhY', 'The lives of two mob hitmen, a boxer, a gangster and his wife, and a pair of diner bandits intertwine in four tales of violence and redemption.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
...
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Forrest Gump', 'Drama', 'Robert Zemeckis', 142, '1994-07-06', 'English', 'USA', '1994-07-06', 'Released', 190.99, 'images/forrest_gump.jpg', 'https://www.youtube.com/watch?v=uPIEn0M8su0', 'The presidencies of Kennedy and Johnson, the Vietnam War, the Watergate scandal and other historical events unfold from the perspective of an Alabama man with an IQ of 75, whose only desire is to be reunited with his childhood sweetheart.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Inception', 'Action', 'Christopher Nolan', 148, '2010-07-16', 'English', 'USA', '2010-07-16', 'Unreleased', 1150.49, 'images/inception.jpg', 'https://www.youtube.com/watch?v=YoHD9XEInc0', 'A thief who steals corporate secrets through the use of dream-sharing technology is given the inverse task of planting an idea into the mind of a C.E.O.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('The Matrix', 'Action', 'Lana Wachowski, Lilly Wachowski', 136, '1999-03-31', 'English', 'USA', '1999-03-31', 'Released', 1110.99, 'images/the_matrix.jpg', 'https://www.youtube.com/watch?v=vKQi3bBA1y8', 'A computer hacker learns from mysterious rebels about the true nature of his reality and his role in the war against its controllers.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
...
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Spirited Away', 'Animation, Adventure, Family', 'Hayao Miyazaki', 125, '2001-07-20', 'Japanese', 'Japan', '2001-07-20', 'Released', 1140.99, 'images/spirited_away.jpg', 'https://www.youtube.com/watch?v=D_SLY-IuDlI', 'A young girl wanders into a world of spirits and demons after her parents are turned into pigs by a witch.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
...
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('The Princess Bride', 'Adventure, Comedy, Family', 'Rob Reiner', 98, '1987-09-25', 'English', 'USA', '1987-09-25', 'Released', 1180.99, 'images/the_princess_bride.jpg', 'https://www.youtube.com/watch?v=JFrKyGFNM2Y', 'Westley must rescue his princess bride from the evil Prince Humperdinck in this comedic fantasy.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Amélie', 'Comedy, Romance', 'Jean-Pierre Jeunet', 113, '2001-04-25', 'French', 'France', '2001-04-25', 'Released', 1100.99, 'images/amelie.jpg', 'https://www.youtube.com/watch?v=hNK_iqFDuws', 'A shy waitress in Montmartre decides to anonymously improve the lives of those around her.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Your Name', 'Animation, Drama, Fantasy', 'Makoto Shinkai', 102, '2016-08-26', 'Japanese', 'Japan', '2016-08-26', 'Released', 1120.99, 'images/your_name.jpg', 'https://www.youtube.com/watch?v=xTJzS7_JqSQ', 'Two teenagers discover they are linked in a strange dream-sharing phenomenon and set out to meet in the waking world.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('The Grand Budapest Hotel', 'Comedy, Crime', 'Wes Anderson', 100, '2014-02-21', 'English', 'USA', '2014-02-21', 'Released', 1140.99, 'images/the_grand_budapest_hotel.jpg', 'https://www.youtube.com/watch?v=1y_0KkvRsXk', 'The concierge of a famous European hotel during the interwar period takes a young employee under his wing.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Blade Runner', 'Sci-Fi, Neo-Noir', 'Ridley Scott', 117, '1982-06-25', 'English', 'USA', '1982-06-25', 'Released', 1130.99, 'images/blade_runner.jpg', 'https://www.youtube.com/watch?v=KP9kbYphvxo', 'A blade runner, a retired police officer who hunts rogue replicants (artificial humans), is tasked with retiring a group of recently arrived replicants.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Seven Samurai', 'Drama', 'Akira Kurosawa', 203, '1954-04-26', 'Japanese', 'Japan', '1954-04-26', 'Released', 1140.49, 'images/seven_samurai.jpg', 'https://www.youtube.com/watch?v=ByfZ63y-VkQ', 'A poor village under constant bandit attacks hires seven unemployed samurai to protect them for the upcoming harvest.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('The Shining', 'Horror', 'Stanley Kubrick', 146, '1980-05-23', 'English', 'USA', '1980-05-23', 'Released', 1110.99, 'images/the_shining.jpg', 'https://www.youtube.com/watch?v=NZleC1Y3HdM', 'A family heads to an isolated hotel for the winter where a sinister presence influences the father into violence, while his psychic son sees horrific forebodings from both past and future.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Rear Window', 'Mystery, Thriller', 'Alfred Hitchcock', 112, '1954-08-01', 'English', 'USA', '1954-08-01', 'Released', 1120.49, 'images/rear_window.jpg', 'https://www.youtube.com/watch?v=cXcY9zvYOO0', 'A wheelchair-bound photographer spies on his neighbors from his apartment window and becomes convinced one of them has committed murder.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Raiders of the Lost Ark', 'Action, Adventure', 'Steven Spielberg', 115, '1981-06-12', 'English', 'USA', '1981-06-12', 'Released', 1150.99, 'images/raiders_of_the_lost_ark.jpg', 'https://www.youtube.com/watch?v=XSL3YwGNKUw', 'Indiana Jones is hired by the U.S. government to find the Ark of the Covenant before Nazis can obtain its powers.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('The Breakfast Club', 'Comedy, Drama', 'John Hughes', 97, '1985-02-22', 'English', 'USA', '1985-02-22', 'Released', 1190.99, 'images/the_breakfast_club.jpg', 'https://www.youtube.com/watch?v=TJW41_t-5mc', 'Five high school students from different social groups are forced to spend a Saturday in detention together, where they bond over their shared experiences and discover that they have more in common than they thought.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Back to the Future', 'Adventure, Comedy, Sci-Fi', 'Robert Zemeckis', 116, '1985-07-26', 'English', 'USA', '1985-07-26', 'Released', 1100.99, 'images/back_to_the_future.jpg', 'https://www.youtube.com/watch?v=hO4tjXzBlCQ', 'Marty McFly, a teenager who travels back in time to 1955 in a time machine built by his friend Doc Brown, must ensure his parents meet and fall in love in order to save his own existence.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('The Terminator', 'Action, Sci-Fi', 'James Cameron', 108, '1984-10-26', 'English', 'USA', '1984-10-26', 'Released', 1120.99, 'images/the_terminator.jpg', 'https://www.youtube.com/watch?v=d0_qZ2Zx7ZM', 'A cyborg assassin is sent back in time to kill Sarah Connor, a young woman whose unborn son is destined to save humanity from a future dominated by machines.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
...
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('The Departed', 'Crime, Drama, Thriller', 'Martin Scorsese', 151, '2006-10-06', 'English', 'USA', '2006-10-06', 'Released', 1160.99, 'images/the_departed.jpg', 'https://www.youtube.com/watch?v=auYbpnEwBBg', 'An undercover cop and a mole in the police attempt to identify each other while infiltrating an Irish gang in South Boston.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
VALUES ('Apocalypse Now', 'Drama, War', 'Francis Ford Coppola', 153, '1979-08-03', 'English', 'USA', '1979-08-03', 'Released', 1170.99, 'images/apocalypse_now.jpg', 'https://www.youtube.com/watch?v=14z_230z19g', 'An American captain during the Vietnam War is sent on a dangerous mission to assassinate the renegade Colonel Kurtz, who has gone AWOL and is waging his own war in Cambodia.');
INSERT INTO Movie (MovieName, Genre, Director, Duration, ReleasedDate, Language, Country, StartDate, Status, ImportPrice, ImageSource, Trailer, Description)
...
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-03 20:00:00', 'Mov001', 'Room01', 850.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-03 00:00:00', 'Mov002', 'Room02', 934.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-03 00:00:00', 'Mov003', 'Room03', 935.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-03 00:00:00', 'Mov004', 'Room04', 836.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-03 00:00:00', 'Mov005', 'Room05', 934.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-03 00:00:00', 'Mov006', 'Room06', 835.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-03 00:00:00', 'Mov007', 'Room07', 835.9);
go
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-04 12:00:00', 'Mov008', 'Room01', 935.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-04 12:00:00', 'Mov009', 'Room02', 936.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-04 12:00:00', 'Mov010', 'Room03', 936.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-04 12:00:00', 'Mov011', 'Room04', 834.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-04 12:00:00', 'Mov012', 'Room05', 835.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-04 12:00:00', 'Mov013', 'Room06', 936.9);
insert into movieschedule (screeningTime, movieid, roomid, PricePerSeat) 
values 
('2024-05-04 12:00:00', 'Mov014', 'Room07', 936.9);
go
...
EXECUTE UpdateProductQuantityByID 'Pro002', 15;
EXECUTE UpdateProductQuantityByID 'Pro003', 12;
EXECUTE UpdateProductQuantityByID 'Pro004', 23;
EXECUTE UpdateProductQuantityByID 'Pro005', 15;
EXECUTE UpdateProductQuantityByID 'Pro006', 19;
EXECUTE UpdateProductQuantityByID 'Pro007', 15;
EXECUTE UpdateProductQuantityByID 'Pro008', 12;
EXECUTE UpdateProductQuantityByID 'Pro009', 14;
EXECUTE UpdateProductQuantityByID 'Pro010', 16;
EXECUTE UpdateProductQuantityByID 'Pro011', 11;
EXECUTE UpdateProductQuantityByID 'Pro012', 17;
EXECUTE UpdateProductQuantityByID 'Pro013', 14;
EXECUTE UpdateProductQuantityByID 'Pro014', 12;
EXECUTE UpdateProductQuantityByID 'Pro011', 16;
EXECUTE UpdateProductQuantityByID 'Pro004', 13;
EXECUTE UpdateProductQuantityByID 'Pro009', 18;
EXECUTE UpdateProductQuantityByID 'Pro006', 16;
go
